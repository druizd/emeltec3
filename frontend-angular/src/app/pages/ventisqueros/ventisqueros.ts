...
import { VentisquerosHistoryExportComponent } from './components/ventisqueros-history-export';
...
@Component({
  ...
  imports: [
    ...
    VentisquerosHistoryExportComponent,
  ],
  ...
  template: `
    <div class="vs-page flex h-full min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <app-ventisqueros-history-export
        [(open)]="historyExportOpen"
        [salaAggregates]="salaAggregates()"
        [coldRoomSensors]="coldRoomSensors()"
        [siteId]="siteId()"
