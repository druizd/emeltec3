...
@Component({
  ...
  template: `
    <div class="flex h-full min-w-0 flex-1 flex-col overflow-hidden" style="background: #F0F2F5;">
      ...
      <!-- Scrollable content -->
      <div class="min-w-0 flex-1 overflow-y-auto overflow-x-hidden" style="padding: 14px 18px 18px;">
            ...
            >
              @for (o of metricOptions; track o.v) {
                <button
                  ...
                  [style.box-shadow]="
                    metric() === o.v ? '0 1px 3px rgba(15,23,42,0.10)' : 'none'
                  "
        ...
        >
          @for (k of kpis(); track k.label) {
            <div
              ...
              [style.background]="
                k.highlight ? 'linear-gradient(135deg, ' + k.accentBg + ' 0%, #FFFFFF 75%)' : '#FFFFFF'
              "
              [style.border]="
                '1px solid ' + (k.highlight ? k.accent + '55' : '#E2E8F0')
              "
              [style.box-shadow]="
                k.highlight
            ...
            @for (tap of taps; track tap) {
              ...
              >
                ...
                >
                  ...
                  >
                    <span class="material-symbols-outlined text-[16px]" [style.color]="
                      isTapHidden(tap)
                        ? '#94A3B8'
