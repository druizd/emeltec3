...
@Component({
  ...
  template: `
    <div class="space-y-3">
      <!-- Banner "próximamente" -->
      <div
        class="relative overflow-hidden rounded-2xl border border-violet-200 bg-gradient-to-br from-violet-50 to-indigo-50 p-6 shadow-sm"
      >
        <div class="relative z-10">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-[10px] font-black uppercase tracking-widest text-violet-400">
                Próximamente
              </p>
          ...
          <p class="mt-4 text-[14px] text-violet-700 leading-relaxed max-w-xl">
            Emeltec Cloud incorporará modelos de predicción entrenados con el historial de cada
            sitio para anticipar fallas, optimizar mantenciones y proyectar consumos antes de que
            ocurran.
          </p>
          <div class="mt-5 flex flex-wrap gap-2">
            <button
              type="button"
              class="inline-flex items-center gap-2 rounded-xl bg-violet-600 px-4 py-2.5 text-[13px] font-bold text-white hover:bg-violet-700 transition-colors"
            >
            ...
            <button
              type="button"
              class="inline-flex items-center gap-2 rounded-xl border border-violet-200 bg-white px-4 py-2.5 text-[13px] font-bold text-violet-700 hover:bg-violet-50 transition-colors"
            >
        ...
        <div class="pointer-events-none absolute right-0 top-0 h-full w-64 opacity-10">
          <span
            class="material-symbols-outlined absolute right-4 top-4 text-[120px] text-violet-600"
            >auto_graph</span
          >
        </div>
      </div>
      ...
      <h3 class="px-1 text-[10px] font-black uppercase tracking-widest text-slate-400">
      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div class="mb-4 flex items-center gap-2">
          <h3 class="text-[10px] font-black uppercase tracking-widest text-slate-400">
            Vista previa — predicción de nivel freático
          </h3>
          <span
            class="rounded-full bg-violet-100 px-2 py-0.5 text-[10px] font-black text-violet-600"
            >Demo</span
          >
        </div>
        ...
        <div class="relative h-40 w-full overflow-hidden rounded-xl bg-slate-50">
          ...
          <div class="absolute inset-0 flex items-center justify-center backdrop-blur-[1px]">
            <div
              class="flex items-center gap-2 rounded-xl border border-violet-200 bg-white/90 px-4 py-2 shadow-sm"
            >
        ...
        <div class="mt-3 flex flex-wrap gap-4 text-[11px] text-slate-400">
          ...
          <span class="flex items-center gap-1.5">
            <span
              class="inline-block h-0.5 w-5 rounded-full border-t-2 border-dashed border-violet-500"
            ></span>
...
export class AnalisisPredictivoComponent {
  readonly capacidades = [
    {
      titulo: 'Predicción de nivel freático',
      descripcion: 'Proyección a 30 días basada en histórico de extracción, lluvia y estación.',
      icon: 'water_drop',
      progreso: 70,
    },
    {
      titulo: 'Detección de anomalías',
      descripcion: 'Identifica comportamientos fuera del patrón antes de que disparen alertas.',
      icon: 'troubleshoot',
      progreso: 55,
    },
    {
      titulo: 'Mantenimiento predictivo',
      descripcion: 'Estima cuándo una bomba o sensor necesitará mantenimiento según desgaste.',
      icon: 'build',
      progreso: 35,
    },
    {
      titulo: 'Optimización de caudal',
      descripcion: 'Sugiere ajustes de operación para reducir consumo energético.',
      icon: 'speed',
      progreso: 20,
    },
    {
      titulo: 'Pronóstico de vencimientos',
      descripcion: 'Anticipa riesgos de vencimiento de DGA, contratos y acreditaciones.',
      icon: 'event_busy',
      progreso: 80,
    },
    {
      titulo: 'Informe automático narrativo',
      descripcion: 'Genera resúmenes en lenguaje natural para el cliente final.',
      icon: 'description',
      progreso: 40,
    },
  ];
