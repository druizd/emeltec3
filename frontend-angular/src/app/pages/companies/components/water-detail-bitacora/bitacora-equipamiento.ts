...
export class BitacoraEquipamientoComponent {
  readonly equipos: Equipo[] = [
    {
      id: '1',
      nombre: 'Bomba sumergible principal',
      modelo: 'SP17-10N',
      fabricante: 'Grundfos',
      serie: 'GF-2021-0047',
      fechaCompra: '15/03/2021',
      garantiaHasta: '15/03/2024',
      estado: 'operativo',
    },
    {
      id: '2',
      ...
      modelo: 'VEGAPULS 64',
      fabricante: 'VEGA',
      serie: 'VP64-2023-A892',
      fechaCompra: '08/06/2023',
      garantiaHasta: '08/06/2025',
      estado: 'operativo',
    },
    {
      id: '3',
      nombre: 'Caudalímetro electromagnético',
      modelo: 'MAG 5100W',
      fabricante: 'Endress+Hauser',
      serie: 'EH-2022-0311',
      fechaCompra: '22/11/2022',
      garantiaHasta: '22/11/2024',
      estado: 'en_mantencion',
    },
    {
      id: '4',
      nombre: 'Panel de control PLC',
      modelo: 'XG5000-S',
      fabricante: 'LS Electric',
      serie: 'LS-2020-1102',
      fechaCompra: '10/01/2020',
      garantiaHasta: '10/01/2022',
      estado: 'operativo',
    },
    {
      id: '5',
      nombre: 'UPS de respaldo 3kVA',
      modelo: 'Smart-UPS 3000',
      fabricante: 'APC',
      serie: 'APC-2023-5578',
      fechaCompra: '05/09/2023',
      garantiaHasta: '05/09/2026',
      estado: 'operativo',
    },
  ];
