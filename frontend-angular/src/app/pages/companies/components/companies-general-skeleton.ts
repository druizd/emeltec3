    ...
    <div class="space-y-6 animate-in fade-in duration-500">
        ...
        <div class="flex flex-col gap-6">
          <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                <div
                  class="flex h-11 w-11 items-center justify-center rounded-xl bg-white ring-1 ring-slate-200"
                >
      ...
      <div class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.8fr)_minmax(320px,0.9fr)]">
        <div class="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div
            class="relative h-[340px] overflow-hidden rounded-[28px] border border-slate-200 bg-gradient-to-b from-slate-50 to-white p-4"
          >
            <div
            ...
            >
              <polyline
                points="4,68 16,63 28,65 40,51 52,52 66,38 80,47 94,72"
                fill="none"
                stroke="#5c7ed6"
                stroke-width="1.3"
              ...
              ></polyline>
              <polyline
                points="4,82 16,80 28,78 40,71 52,69 66,65 80,71 94,77"
                fill="none"
                stroke="#8cbf6d"
                stroke-width="1.1"
                stroke-linecap="round"
              ...
              ></polyline>
              <polyline
                points="4,88 16,88 28,32 40,36 52,82 66,80 80,81 94,86"
                fill="none"
                stroke="#efc557"
                stroke-width="1.1"
                stroke-linecap="round"
        ...
        <div class="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div
            class="relative h-[340px] overflow-hidden rounded-[28px] border border-slate-200 bg-gradient-to-br from-slate-50 via-slate-100/60 to-sky-50/40"
          >
            <div
            ...
            <div
              class="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-3"
            >
              <div
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 2xl:grid-cols-4">
          <div class="rounded-3xl border border-slate-200 bg-slate-50/70 p-5">
            <div class="flex items-start justify-between gap-4">
              ...
              <div
                class="flex h-11 w-11 items-center justify-center rounded-2xl bg-white ring-1 ring-slate-200"
              >
                <div class="skeleton h-5 w-5 rounded-lg"></div>
              </div>
            </div>
