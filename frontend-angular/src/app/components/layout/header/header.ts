        ...
        <div class="flex items-center gap-1.5">
          ...
          <div class="relative">
            <button
              ...
              class="ml-1 flex h-[30px] w-[30px] items-center justify-center rounded-full bg-gradient-to-br from-[#0dafbd] to-[#04606a] text-[11px] font-bold text-white ring-2 ring-transparent transition-all hover:ring-[rgba(13,175,189,0.30)] focus-visible:outline-none focus-visible:ring-[#0DAFBD]"
